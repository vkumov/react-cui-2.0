...
const Textarea = (_ref) => {
  ...
  return React__default.createElement("div", {
    className: `form-group${appendClass(labelInline, "label--inline")}${appendClass(className)}${formik.getIn(touched, field.name) && formik.getIn(errors, field.name) ? " form-group--error" : ""}`
  }, React__default.createElement("div", {
    className: "form-group__text"
