...
const toast = (type, title, message, copyError = true, containerId = "_GLOBAL_") => reactToastify.toast(React.createElement(Toast, {
  type,
  title,
  message,
  copyError
...
const ToastContainer = props => React.createElement(reactToastify.ToastContainer, _extends({
  transition: Fade
}, props, {
  closeButton: false,
  style: {
