...
}), React__default.createElement("small", null, bytes.format(file.size, {
  unitSeparator: " "
})))));
...
class Dropzone extends React__default.Component {
  ...
  render() {
    ...
    }, this.props.label) : null, React__default.createElement(ReactDropzone, {
...
const connected = formik.connect(Dropzone);
...
const Progressbar = (_ref) => {
  ...
  }), withLabel ? label ? React__default.createElement("div", {
...
class Select extends React__default.Component {
  ...
  render() {
    ...
    return React__default.createElement("div", _extends({
      className: `form-group dropdown${compressed ? " input--compressed" : ""}${this.state.isOpen ? " active" : ""}${inline ? " label--inline" : ""}${up ? " dropdown--up" : ""}${disabled ? " disabled" : ""}${className ? ` ${className}` : ""}${formik.getIn(touched, field.name) && formik.getIn(errors, field.name) ? " form-group--error" : ""}` // (asyncValidating ? " form-group--loading" : "")
      ,
...
const Fade = reactToastify.cssTransition({
  enter: "fadeIn",
  exit: "fadeOut",
  duration: 300
});
const toast = (type, title, message, copyError = true, containerId = "_GLOBAL_") => reactToastify.toast(React__default.createElement(Toast, {
  type,
  title,
  message,
  copyError
...
const ToastContainer = props => React__default.createElement(reactToastify.ToastContainer, _extends({
  transition: Fade
}, props, {
  closeButton: false,
  style: {
...
const Input = (_ref) => {
  ...
  return React__default.createElement("div", {
    className: `form-group${className ? ` ${className}` : ""}${formik.getIn(touched, field.name) && formik.getIn(errors, field.name) ? " form-group--error" : ""}${inline === "form" || inline === "both" ? " form-group--inline" : ""}${inline === "label" || inline === "both" ? " label--inline" : ""}${icon ? " input--icon" : ""}`
  }, React__default.createElement("div", {
    className: "form-group__text"
    ...
    className: `icon-${icon}`
  })) : null), helpBlock && formik.getIn(touched, field.name) && formik.getIn(errors, field.name) ? React__default.createElement(InputHelpBlock, {
    text: formik.getIn(errors, field.name)
  }) : null);
};
...
const Modal = (_ref4) => {
  ...
  }, contentProps), closeIcon && closeHandle ? React__default.createElement("a", {
    className: "modal__close",
    onClick: closeHandle
  }, React__default.createElement("span", {
    className: "icon-close"
  })) : null, title ? React__default.createElement(ModalHeader, null, React__default.createElement("h1", {
...
const ConfirmationModal = ({
  ...
  return React__default.createElement(Modal, {
    ...
    autoClose: autoClose,
    title: "Confirmation"
  }, React__default.createElement(ModalBody, null, React__default.createElement("p", null, prompt)), React__default.createElement(ModalFooter, null, React__default.createElement(Button.Ghost, {
    onClick: closeHandle
...
const ConfirmationListener = () => {
  ...
  return React__default.createElement(ConfirmationModal, {
    isOpen: modalShown,
    prompt: modal.prompt,
    confirmHandle: async () => {
