...
const DefaultTablePagination = ({
  ...
  }, "Page:"), React__default.createElement(Pagination, {
    firstAndLast: true,
    icons: true,
    perPage: perPage,
    total: total,
...
const Table = (_ref) => {
  ...
  const thead = React__default.useMemo(() => children ? asArray(children).find(child => child.type === "theady") : null, [children]);
  const total = React__default.useMemo(() => data ? data.length : tbody.props.children.length, [data, tbody]);
  ...
  }))), React__default.createElement(GenericTable, props, thead, data ? data.slice(position, position + perPage).map((row, rid) => React__default.createElement("tr", {
    key: rid
...
const Modal = (_ref4) => {
  ...
  }, closeIcon && closeHandle ? React__default.createElement("a", {
...
const Tabs = ({
  ...
  }, React__default.createElement(TabsHeader, {
