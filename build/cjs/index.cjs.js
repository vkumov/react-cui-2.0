...
const MenuElement = /*#__PURE__*/ React.forwardRef(({ selected , className , icon , children , submenu , ...props }, ref)=>{
    ...
    }, icon ? /*#__PURE__*/ React.isValidElement(icon) ? /*#__PURE__*/ React__default["default"].createElement(React__default["default"].Fragment, null, icon, /*#__PURE__*/ React.isValidElement(children) ? children : /*#__PURE__*/ React__default["default"].createElement("span", {
...
const Menu = /*#__PURE__*/ React.forwardRef(({ children , label , noChevron , placement , strategy: providedStrategy , portalRoot , alwaysClose , onOpen , nested , withSizeLimit , ...props }, ref)=>{
    ...
    const listContentRef = React.useRef(React.Children.map(children, (child)=>/*#__PURE__*/ React.isValidElement(child) ? child.props.label : null));
    ...
    const { x , y , reference , floating , strategy , refs , context  } = react.useFloating({
        open,
        onOpenChange: (st)=>{
    ...
    const floatingNodeRef = React.useRef(null);
    const mergedReferenceRef = useCallbackRef.useMergeRefs([
        ref,
        reference
    ]);
    ...
    return /*#__PURE__*/ React__default["default"].createElement(react.FloatingNode, {
        id: nodeId
    }, /*#__PURE__*/ React.isValidElement(label) ? /*#__PURE__*/ React.cloneElement(label, {
        ...getReferenceProps({
            ...props,
            ...
            ...nested ? {
                className: cx__default["default"]("menu_item", {
                    open
                }),
                role: "menuitem",
                onKeyDown (event) {
                ...
                className: cx__default["default"](styles$2.menu_root, label.props.className, {
                    open,
                    [styles$2.with_chevron]: !noChevron
                })
            }
        })
    }) : /*#__PURE__*/ React__default["default"].createElement(MenuElement, {
        submenu: nested,
        ...getReferenceProps({
            ...props,
            ref: mergedReferenceRef,
            ...
            ...nested ? {
                ...
                className: cx__default["default"](styles$2.menu_root, {
                    open,
                    [styles$2.with_chevron]: !noChevron
                })
            }
        })
    }, label), /*#__PURE__*/ React__default["default"].createElement(react.FloatingPortal, {
        root: portalRoot
        ...
        nodeRef: floatingNodeRef
            ...
            ...getFloatingProps({
                className: cx__default["default"]("dropdown", styles$2.active, styles$2.dropdown, {
        ...
        }, React.Children.map(children, (child, index)=>/*#__PURE__*/ React.isValidElement(child) && /*#__PURE__*/ React.cloneElement(child, getItemProps({
                tabIndex: -1,
                role: "menuitem",
                className: "menu_item",
                ref (node) {
...
const Dropdown = /*#__PURE__*/ React.forwardRef(({ children , placement ="bottom-start" , ...props }, ref)=>{
    return /*#__PURE__*/ React__default["default"].createElement(react.FloatingTree, null, /*#__PURE__*/ React__default["default"].createElement(Menu, {
        placement: placement,
        ...props,
        nested: false,
        ref: ref
...
const MenuDivider = /*#__PURE__*/ React.forwardRef(({ className , ...props }, ref)=>/*#__PURE__*/ React__default["default"].createElement("div", {
        ...props,
        className: cx__default["default"]("divider", className),
        ref: ref
    }));
MenuDivider.displayName = "MenuDivider";
const MenuGroup = /*#__PURE__*/ React.forwardRef(({ className , header , children , ...props }, ref)=>/*#__PURE__*/ React__default["default"].createElement("div", {
        className: cx__default["default"]("dropdown__group", className),
        ...props,
        ref: ref
...
const DefaultTablePagination = ({ perPageUp =false , paginationProps ={} , total , position , onPageChange , onPerPageChange  })=>{
    ...
    return /*#__PURE__*/ React__default["default"].createElement("div", {
        ...
        label: /*#__PURE__*/ React__default["default"].createElement("a", null, perPage),
        alwaysClose: true,
        ...
        250,
        500
    ].map((v)=>/*#__PURE__*/ React__default["default"].createElement(MenuElement, {
...
const Table = /*#__PURE__*/ React.forwardRef(({ pagination =DefaultTablePagination , paginationLocation ="bottom-right" , paginationProps ={
    ...
    const [perPage, setPerPage] = React__default["default"].useState(50);
    const tbody = React__default["default"].useMemo(()=>children ? asArray(children).find((child)=>child.type === "tbody") : null, [
        children
    ]);
    const thead = React__default["default"].useMemo(()=>children ? asArray(children).find((child)=>child.type === "thead") : null, [
        children
    ]);
    ...
    return /*#__PURE__*/ React__default["default"].createElement(React__default["default"].Fragment, null, Boolean(paginationLocation.includes("top-")) && /*#__PURE__*/ React__default["default"].createElement("div", {
        ...
        ref: forwardedRef
            ...
            key: rid
                ...
                key: cid
            }, col)))) : asArray(tbody.props.children).slice(position, position + perPage))), Boolean(paginationLocation.includes("bottom-")) && /*#__PURE__*/ React__default["default"].createElement("div", {
...
const ModalFooter = /*#__PURE__*/ React.forwardRef(({ className =null , children , ...props }, ref)=>/*#__PURE__*/ React__default["default"].createElement("div", {
        className: `modal__footer${appendClass(className)}`,
        ...props,
        ref: ref
    }, children));

const ModalBody = /*#__PURE__*/ React.forwardRef(({ className =null , children , ...props }, ref)=>/*#__PURE__*/ React__default["default"].createElement("div", {
...
function confirmation(prompt, onConfirm, confirmType = "primary", confirmText = "Confirm", dontAskAgain = {
    ...
    return new Promise((resolve)=>eventManager.emit("showModal", {
            ...
            prompt: /*#__PURE__*/ React__default["default"].createElement("p", null, prompt),
            onConfirm,
            confirmText,
            confirmType,
            dontAskAgain,
...
const InputChips = /*#__PURE__*/ React__default["default"].forwardRef(({ chipsColor ="light" , addOnBlur =true , delimiters =[
    ...
    const [value, setValue] = React.useState(emptyList);
    React.useEffect(()=>{
    ...
    return /*#__PURE__*/ React__default["default"].createElement(ConditionalWrapper, {
        ...
        }, v)))) : null, /*#__PURE__*/ React__default["default"].createElement("div", {
        ...
        className: "chips-inner"
            ...
            key: `${v}-${i}`,
            className: "no-margin-bottom"
        }, v)))) : null, showInput ? /*#__PURE__*/ React__default["default"].createElement("input", {
        type: "text",
...
const EditableSelect = /*#__PURE__*/ React.forwardRef(({ compressed =false , prompt ="Select an option" , inline =false , type ="text" , children , label =null , error =null , onChange =null , value: initialValue = undefined , editable =false , multi =false , displayValues =false , disabled , className , divRef , options , onSelect =null , onDeselect =null , ...input }, inputRef)=>{
    ...
    return /*#__PURE__*/ React__default["default"].createElement("div", {
        ...
        isSelected: isSelected
            ...
            key: idx,
            value: opt.value
        }, opt.value)) : children)), error ? /*#__PURE__*/ React__default["default"].createElement(InputHelpBlock, {
        text: error
    }) : null);
});
...
const OptionDisplay = ({ children , value , activeRef , active , className , disabled , id , ...props })=>{
    return /*#__PURE__*/ React__default["default"].createElement("div", {
        className: cx__default["default"](styles$1.segmented_option_control, className, {
...
function UrefedSegmented({ options , value , label , inline , className , fullWidth , small , ...props }, ref) {
    ...
    const activeRefCb = React.useCallback((node)=>{
        if (node !== null) {
            setEl(node);
        } else setEl(null);
    }, []);
    return /*#__PURE__*/ React__default["default"].createElement("div", {
        ...
        className: cx__default["default"](styles$1.form_group, {
        ...
        className: cx__default["default"](styles$1.segmented_root, {
...
const GenericPopover = /*#__PURE__*/ React.forwardRef(function GenericPopoverRefed({ className , children , wrapperClassName , state , offset: offsetOptions , ...props }, ref) {
    ...
    return /*#__PURE__*/ React__default["default"].createElement("div", {
        ref: merged,
        className: cx__default["default"](styles.wrapper, wrapperClassName, {
...
const Popover = ({ children , element , onClose , onOpen , showClassName , overlay: overlayProvided , showOverlay: overlayShowProvided , placement , portalRoot , offset: offsetOptions = 4 , closeRef , initialFocus , guardsFocus , modalFocus , closeOnFocusOut  })=>{
    ...
    const [overlayShow, setOverlayShow] = React.useState(overlayShowProvided);
    const [overlay, setOverlay] = React.useState(overlayProvided);
    const ref = useCallbackRef.useMergeRefs([
        reference,
        element.ref
    ]);
    ...
    return /*#__PURE__*/ React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/ React.cloneElement(element, getReferenceProps({
        ref,
        ...element.props,
...
const PopoverTitle = /*#__PURE__*/ React.forwardRef(({ className , noLine , ...props }, ref)=>{
    return /*#__PURE__*/ React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/ React__default["default"].createElement("h5", {
        ref: ref,
        className: cx__default["default"]("no-margin-bottom", className),
        ...props
    }), !noLine && /*#__PURE__*/ React__default["default"].createElement("hr", {
...
exports.Gauge = Gauge;
exports.GenericPopover = GenericPopover;
