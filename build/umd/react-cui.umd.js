(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var ToastContainer = function (_a) {
        ...
        return (React__default['default'].createElement(ToastContainer$1, __assign({ transition: Fade, position: position, autoClose: autoClose, draggable: draggable, hideProgressBar: hideProgressBar, containerId: containerId }, props, { closeButton: false, style: {
                width: "unset",
            } })));
    };
    ...
    var css_248z$1 = ".cui .timeline.simplified .timeline__content:before{content:none}.cui .timeline.simplified:before{z-index:0}.cui .timeline.simplified .timeline__icon{position:relative;z-index:1}.cui .timeline.simplified .timeline__content{background:transparent;padding-left:0}.cui .timeline.simplified .timeline__time{display:block;font-size:var(--cui-font-size-sm)!important;margin-bottom:var(--cui-spacing)!important;margin-top:0!important}";
        ...
        return (React__default['default'].createElement(ConditionalWrapper, { wrapper: React__default['default'].createElement("div", { className: "form-group" + appendClass(className) + appendClass(error, "form-group--error"), ref: ref }), condition: outerWrap },
            React__default['default'].createElement("div", { className: "form-group__text chips" + appendClass(!outerWrap && className, className) },
                ...
                React__default['default'].createElement("div", { className: "input" },
                    Array.isArray(value) && value.length ? (React__default['default'].createElement("span", { className: "chips-outer" },
